function CCard(bFolded,iType,pStartingPoint,szFrame,iValue,iSuit,bWaste,oParentContainer){
    var _bFolded;
    var _bClickable;
    var _bDragging;
    var _bWasteCard;
    ...
    this._init = function(bFolded,iType,pStartingPoint,szFrame,iValue,iSuit,bWaste){
        ...
        _oMsg = new CTLText(_oContainer, 
                    -CARD_WIDTH/2, -CARD_HEIGHT/2, CARD_WIDTH, 50, 
    ...
    this.setAsWasteCard = function(bWaste){
        _bWasteCard = bWaste;
       // _oMsg.refreshText("waste "+_bWasteCard)
    };
    ...
    this._init(bFolded,iType,pStartingPoint,szFrame,iValue,iSuit,bWaste);
