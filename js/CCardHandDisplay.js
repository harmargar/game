function CCardHandDisplay(iIndex,oDirMov,pStartPos,iRot,oParentContainer){
    ...
    this.addCard = function(oCardDealed){
        ...
        var oCard = new CCard(true,CARD_HAND,new CVector2(iXPos,CARD_HEIGHT),oCardDealed.getFrame(),oCardDealed.getValue(),oCardDealed.getSuit(),oCardDealed.isWasteCard(),_oContainer);
